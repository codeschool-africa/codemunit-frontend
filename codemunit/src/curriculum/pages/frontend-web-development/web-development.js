        ...
        <div className="curriculum-container">
            ...
            <div className="main-content">
                <div className="container">
                                ...
                                <div className="dropdown dropdown-active sub-section-1">
                                    <ul>
                                        ...
                                        <div className={isWebStarter
                                            ...
                                            <ul>
                                                <li className="anchor">
                                                    <Link to={`${url}/what-is-internet`}>What is the internet?</Link>
                                                </li>
                                                <li className="anchor">
                                                    <Link to={`${url}/introduction-to-web`}>What is a web?</Link>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className={isFrontend
                                            ...
                                            <ul>
                                                ...
                                                <div className={isCssFramework
                                                    ...
                                                    <ul>
                                                        <li className="anchor">
                                                            <Link to={`${url}/responsive-web-design-with-media-queries`}>Responsive web design with media queries</Link>
                                                        </li>
                                                        <li className="anchor">
                                                ...
                                                <li className="anchor">
                                                    <Link to={`${url}/advanced-html5`}>Advanced HTML5</Link>
                                                </li>
                    ...
                    <div className={isNavOpen ? "main-open curriculum-showcase" : "curriculum-showcase"}>
                        <div className="div">
...
const Error = () => {
    return (
        <div className="main-page-content">
            <div className="header">
                <div className="container">
                    <h1 className="error">Ooops!! page not found, check the url or navigate through the menu<br/> to go to your destination</h1>
                    <div className="content-info">
                        <span>
                            {/* Course duration: <span>12hrs</span> */}
                        </span>
